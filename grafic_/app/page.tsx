...
export default function Page() {
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center gap-5 bg-neutral-100 px-4 py-6 md:py-10">
      ...
      <div
        className={cn(
          "relative flex h-[812px] w-full max-w-[390px] flex-col overflow-hidden rounded-[36px] border-[10px] border-neutral-900 bg-tg-bg text-tg-text shadow-2xl",
          dark && "tg-dark",
        )}
      >
        ...
        {tab === "chat" ? (
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {tab === "documents" && <DocumentsScreen onCelebrate={() => setCelebrate(true)} />}
        ...
        {/* Celebration overlay — covers the whole phone frame */}
